      ...
      <html lang="en" class="scroll-smooth">
        <head>
          ...
          <style>
            ...
            /* Additional responsive fixes for iframe */
        ...
        <body class="overflow-x-hidden font-Schibsted leading-8 bg-white text-primary dark:bg-darkTheme dark:text-white">
          <div id="app"></div>
          ...
          <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
              try {
                ...
                document.getElementById("app").innerHTML = "<pre style='color:red'>" + e + "</pre>";
              }
            });
